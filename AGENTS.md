...
- **Preferred locations**:
	- `redesign/sandbox/` in this repo.
	- The `sandbox` repo at `c:\Users\Joel\Documents\Repos\sandbox`.
- **Allowed**:
...
- Use only project‑standard commands (for example, static site tooling or any documented `npm`/build scripts).
...
- `Night Mode` designs across the remainign main visual components.
- Footer links sizing and paralax componitization.
- Top Level `_temp_`'s -> Sandbox, Gallery, Landing
...
Made changes to the landing page to show more relevant info as well as make the page consistent and portable to [joeldombek.com](http://www.joeldombek.com) FTP

- Landing page to show more relevant info
...
<!-- <img title="EXO - Content Manger v1" alt="EXO - Content Manger hero v1 " style="display:inline-block;height:150px;min-height:100%;" src="https://pbs.twimg.com/profile_banners/1948686367573291008/1753445934/1500x500"><img title="EXO Logo" alt="EXO Logo" style="border-radius:32px;display:inline-block;width:150px;height:150px;" src="https://pbs.twimg.com/profile_images/1948797731247435777/l39Djua6_400x400.jpg"> -->

### July 2025

- Asset repo and contents added for features
- Offplatform refresh of links
- Exo project `-init`
- Environment changes `github.com/pages`
- S-Tier `https://pbs.twimg.com/media/GtQwDMYXUAE_4G5?format=png&name=large`
...
---
<img title="S-Tier b y Joel Dombek NEW! clothing line for Fall 2025" alt="S-Tier Tag" style="display:inline-block;height:auto;max-width:400px" src="https://joeldom.github.io/asset/chip-logo.png">
