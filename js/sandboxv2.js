...
function startShuffling() {
    ...
    termContainer.classList.remove("paused"); // Remove the "paused" class
    termContainer.removeEventListener("click", startShuffling);
    termContainer.addEventListener("click", pauseShuffling);
}

function pauseShuffling() {
    clearInterval(intervalId);
    //termContainer.textContent = "Resume";
    termContainer.classList.add("paused"); // Add the "paused" class
    termContainer.removeEventListener("click", pauseShuffling);
    termContainer.addEventListener("click", startShuffling);
}
