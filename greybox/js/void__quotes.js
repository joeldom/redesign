...
$(".quote-toggle").click(function() {
  ...
  $(collapse_content_selector).slideToggle(function() {
    if ($(this).css("display") === "none") {
      toggle_switch.html(
        'Expand section &nbsp;<i class="material-icons">add</i>'
      );
    } else {
      toggle_switch.html(
        'Collapse section &nbsp;<i class="material-icons">clear</i>'
      );
    }
  });
});
...
$(document).ready(function() {
  var leadBG = new Array(
      "palette-brandblue palette-inverse cool",
      "palette-brandblue palette-inverse warm"
    ),
